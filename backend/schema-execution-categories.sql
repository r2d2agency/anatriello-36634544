...
CREATE TABLE IF NOT EXISTS merch_execution_categories (
  ...
  category_after_photo TEXT,
  category_after_photo_at TIMESTAMPTZ,
  category_after_photo_latitude DOUBLE PRECISION,
  category_after_photo_longitude DOUBLE PRECISION,
